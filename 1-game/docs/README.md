...
Esta carpeta contiene la documentacion actualizada para la entrega y mejoras personales.
...
- Rutas referenciadas se dan relativas a `1-game/`.
- Los ejemplos de codigo son guias; requieren integracion en `src/`.
- El foco es cumplir la entrega con cambios minimos y claros.
